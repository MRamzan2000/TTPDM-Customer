...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Campaign> _filterCampaigns() {
    ...
    switch (selectedIndex.value) {
      case 1:
        campaigns =
            addCampaignController.approvedCampaigns.value?.campaigns ?? [];
        break;
      case 2:
        campaigns =
            addCampaignController.rejectedCampaigns.value?.campaigns ?? [];
        break;
      case 0:
      default:
        campaigns =
            addCampaignController.pendingCampaigns.value?.campaigns ?? [];
        break;
    }
    ...
    if (_searchQuery.isEmpty) {
      ...
      return campaigns
          .where((campaign) => campaign.adsName
              .toLowerCase()
